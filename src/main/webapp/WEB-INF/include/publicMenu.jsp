...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a href="${pageContext.request.contextPath}/product/list" title="商品列表">商品列表</a></li>
                    <li><a href="${pageContext.request.contextPath}/category/list" title="商品产品分类管理">商品分类管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
