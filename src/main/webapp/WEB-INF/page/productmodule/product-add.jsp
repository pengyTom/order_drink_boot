...
<article class="cl pd-20">
    <form action="${pageContext.request.contextPath}/product/addProduct" method="post" enctype="multipart/form-data"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <label for="price"></label><input type="text" class="input-text" autocomplete="off" value=""
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <label for="zan"></label><input type="text" class="input-text" autocomplete="off" value=""
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <label for="number"></label><input type="text" class="input-text" autocomplete="off" value=""
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <label for="miaoshu"></label><input type="text" class="input-text" autocomplete="off" value=""
                                                    placeholder="" id="miaoshu"
                                                    name="miaoshu">
            </div>
        </div>
