    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <label for="newCateName"></label><input type="text" class="input-text" style="width:150px"
                                                        placeholder="输入分类名称" id="newCateName" name="">
                    ...
                    <tr class="text-c">
                        ...
                        <td><a title="编辑" href="javascript:"
                            ...
                            <i class="Hui-iconfont">&#xe6df;</i></a> <a deleteLink="true" title="删除"
                                                                        href="${pageContext.request.contextPath}/category/delCategory?id=${category.id}"
