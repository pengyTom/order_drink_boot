...
<article class="cl pd-20">
    <form action="${pageContext.request.contextPath}/product/updateProduct" method="post" enctype="multipart/form-data"
          class="form form-horizontal" id="form-admin-add" target="_parent">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>商品名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <label for="name"></label><input type="text" class="input-text" value="${product.name}" placeholder=""
                                                 id="name" name="name">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <label for="price"></label><input type="text" class="input-text" autocomplete="off"
                                                  value="${product.price}" placeholder="" id="price" name="price">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>人气：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <label for="zan"></label><input type="text" class="input-text" autocomplete="off" value="${product.zan}"
                                                placeholder="" id="zan" name="zan">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>销量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <label for="number"></label><input type="text" class="input-text" autocomplete="off"
                                                   value="${product.number}" placeholder="" id="number" name="number">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <label for="miaoshu"></label><input type="text" class="input-text" autocomplete="off"
                                                    value="${product.miaoshu}" placeholder="" id="miaoshu"
                                                    name="miaoshu">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <img src="${pageContext.request.contextPath}/${product.imageurl}" width="100px" height="50px" alt="">
            </div>
