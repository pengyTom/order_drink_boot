    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l">
                    <a href="javascript:" onclick="admin_permission_add('添加权限节点','adminPerAddUI','','310')"
                ...
                <c:forEach items="${ps}" var="permission">
                    <tr class="text-c">
                        ...
                        <td><a title="编辑" href="javascript:"
                               onclick="admin_permission_edit('角色编辑','editPermission?id=${permission.id}','1','','310')"
                               class="ml-5" style="text-decoration:none">
                            <i class="Hui-iconfont">&#xe6df;</i></a> <a deleteLink="true" title="删除"
                                                                        href="${pageContext.request.contextPath}/config/deletePermission?id=${permission.id}"
