...
<article class="cl pd-20">
    <form action="${pageContext.request.contextPath}/config/updateRole" method="post" class="form form-horizontal"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <label for="roleName"></label><input type="text" class="input-text" value="${role.name}" placeholder=""
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <label for=""></label><input type="text" class="input-text" value="${role.desc_}" placeholder="" id=""
                                             name="desc_">
            </div>
        </div>
        <div class="row cl">
