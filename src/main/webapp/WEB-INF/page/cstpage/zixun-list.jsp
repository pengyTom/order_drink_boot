...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
        ...
        资讯管理
        <span class="c-gray en">&gt;</span>
        资讯列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                ...
                <c:forEach items="${list}" var="z">
                    <tr class="text-c">
                        ...
                        <td>
                            ...
                            <a deleteLink="true" title="删除" href="${pageContext.request.contextPath}/zixun/del?id=${z.id}"
                               class="ml-5" style="text-decoration:none">
